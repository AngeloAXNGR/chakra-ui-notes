...
export default function Create() {
  return (
    <Box maxW="480px">
      ...
      {/* Chakra UI doesnt have a component for forms just yet */}
      {/* Only from input elements */}
...
// Action function coming from react-router-dom
// pass this function as an action prop at App.tsx
